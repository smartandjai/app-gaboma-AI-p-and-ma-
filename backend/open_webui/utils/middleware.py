...
def serialize_output(output: list) -> str:
    ...
    for idx, item in enumerate(output):
        ...
        elif item_type == "gabomagpt:code_interpreter":
        ...
        async def response_handler(response, events):
            def tag_output_handler(content_type, tags, output):
                ...
                output_type_map = {
                    ...
                    "code_interpreter": "gabomagpt:code_interpreter",
                }
                ...
                if last_type == "message":
                    ...
                    for start_tag, end_tag in tags:
                        ...
                        if match:
                            ...
                            elif output_item_type == "gabomagpt:code_interpreter":
                                output.append(
                                    {
                                        "type": "gabomagpt:code_interpreter",
                                        "id": output_id("ci"),
                                        "status": "in_progress",
                                        "start_tag": start_tag,
                                        "end_tag": end_tag,
                    ...
                    or (
                        last_type == "gabomagpt:code_interpreter"
                    ...
                    elif last_type == "gabomagpt:code_interpreter":
            ...
            try:
                ...
                if DETECT_CODE_INTERPRETER:
                    ...
                    while (
                        output
                        and output[-1].get("type") == "gabomagpt:code_interpreter"
